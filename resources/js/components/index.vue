    ...
    <div class="max-w-screen-lg mx-auto mb-6 lg:my-6 shadow">
        <div class="lg:grid grid-cols-3 text-gray-50 relative">
            <nav class="inside absolute transform -rotate-90 top-28 hidden lg:flex">
                ...
                <div class="bg-gray-200 hover:bg-gray-400 border-l border-gray-300 cursor-pointer ease-in-out transition-all duration-150" @click="openModal('contact')"><span class="px-4 text-xl py-2 block text-gray-400 hover:text-gray-200 transition-all ease-in-out duration-300" style="font-family:exolight;">contact</span></div>
            </nav>
            ...
            <div class="bg-black bg-opacity-40 p-6 lg:p-12">
                <div class="hidden lg:block aspect-w-1 aspect-h-1 rounded-full">
                    <div class="self w-full rounded-full" style="background: url('/img/pixelrubble-reverse.jpg') center center no-repeat; background-size: cover;"></div>
                </div>
                <div class="sideInfo lg:pt-6 pb-4">
                    <div class="sideBarIcons">
                        ...
                        <div class="flex gap-2"><span class="fa-stack fa-sm flex-none"><i class="fas fa-circle fa-stack-2x text-blue-400"></i><i class="fa fa-envelope-o fa-stack-1x fa-inverse"></i></span><p class="flex-grow cursor-pointer text-white hover:text-blue-400 ease-in-out transition-all duration-150" @click="openModal('contact')">info@robert-herring.com</p></div>
                        ...
                        <div class="flex gap-2"><span class="fa-stack fa-sm flex-none"><i class="fas fa-circle fa-stack-2x text-blue-400"></i><i class="fa fa-instagram fa-stack-1x fa-inverse"></i></span><p class="flex-grow cursor-pointer text-white hover:text-blue-400 ease-in-out transition-all duration-150" @click="openModal('instagram')">FromTheRubble</p></div>
